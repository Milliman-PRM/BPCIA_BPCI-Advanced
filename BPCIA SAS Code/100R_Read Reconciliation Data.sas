...
TRANS_IP_STAY_6 :
TRANS_IP_STAY_7 :
NATURAL_DISASTER_CCN_FLAG :
DEATH_DUR_POSTDSCHRG :
TOT_STD_ALLOWED :
TOT_POST_EPI_STD_ALLOWED :
TOT_RAW_ALLOWED :
TOT_POST_EPI_RAW_ALLOWED :
TOT_STD_ALLOWED_OPL :
TOT_STD_ALLOWED_IP :
TOT_STD_ALLOWED_DM :
TOT_STD_ALLOWED_PB :
...
POST_EPI_STD_ALLOWED_OPL :
POST_EPI_STD_ALLOWED_IP :
POST_EPI_STD_ALLOWED_DM :
POST_EPI_STD_ALLOWED_PB :
POST_EPI_STD_ALLOWED_SN :
POST_EPI_STD_ALLOWED_HS :
POST_EPI_STD_ALLOWED_HH_NONRAP :
ORIGDS :
LTI :
FRACTURE_FLAG :
TKA_FLAG :
...
POST_EPI_STD_PMT_FCTR_WIN_1_99 :
