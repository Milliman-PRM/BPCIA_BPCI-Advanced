...
%macro BASELINE(client);
	...
	libname arch "R:\data\HIPAA\BPCIA_BPCI Advanced\04 - Target Price Reports\Distributed Baseline\&client.\Stacked Files";
	...
	data arch_pre_&client._tp_comp;
		...
		* replace EPI_INDEX when needed;
			 if INITIATOR_BPID_old='1681-0004' then do; BPID_change=1; INITIATOR_BPID='1374-0004'; CONVENER_ID='1374_0001'; EPI_INDEX=tranwrd(EPI_INDEX_OLD,'1681-0004','1374-0004'); end;
		else if INITIATOR_BPID_old='5211-0002' then do; BPID_change=1; INITIATOR_BPID='1374-0008'; CONVENER_ID='1374_0001'; EPI_INDEX=tranwrd(EPI_INDEX_OLD,'5211-0002','1374-0008'); end;
		else if INITIATOR_BPID_old='5211-0003' then do; BPID_change=1; INITIATOR_BPID='1374-0009'; CONVENER_ID='1374_0001'; EPI_INDEX=tranwrd(EPI_INDEX_OLD,'5211-0003','1374-0009'); end;
		else if INITIATOR_BPID_old='1234-0000' then do; BPID_change=1; INITIATOR_BPID='5084-0042'; CONVENER_ID='5084_0001'; EPI_INDEX=tranwrd(EPI_INDEX_OLD,'1234-0000','5084-0042'); PGP_ACH='ACH'; ASSOC_ACH_CCN=CCN_TIN; end;
		else if INITIATOR_BPID_old='1971-0000' then do; BPID_change=1; INITIATOR_BPID='5084-0064'; CONVENER_ID='5084_0001'; EPI_INDEX=tranwrd(EPI_INDEX_OLD,'1971-0000','5084-0064'); PGP_ACH='ACH'; ASSOC_ACH_CCN=CCN_TIN; end;
		else if INITIATOR_BPID_old='2579-0000' then do; BPID_change=1; INITIATOR_BPID='5084-0034'; CONVENER_ID='5084_0001'; EPI_INDEX=tranwrd(EPI_INDEX_OLD,'2579-0000','5084-0034'); PGP_ACH='ACH'; ASSOC_ACH_CCN=CCN_TIN; end;
		else if INITIATOR_BPID_old='5398-0004' then do; BPID_change=1; INITIATOR_BPID='5392-0004'; CONVENER_ID='5392_0001'; EPI_INDEX=tranwrd(EPI_INDEX_OLD,'5398-0004','5392-0004'); end;
		else if INITIATOR_BPID_old='1931-0002' then do; BPID_change=1; INITIATOR_BPID='5478-0002'; CONVENER_ID='5478_0001'; EPI_INDEX=tranwrd(EPI_INDEX_OLD,'1931-0002','5478-0002'); end;
		else if INITIATOR_BPID_old='1931-0003' then do; BPID_change=1; INITIATOR_BPID='5479-0002'; CONVENER_ID='5479_0001'; EPI_INDEX=tranwrd(EPI_INDEX_OLD,'1931-0003','5479-0002'); end;
		else if INITIATOR_BPID_old='1931-0004' then do; BPID_change=1; INITIATOR_BPID='5480-0002'; CONVENER_ID='5480_0001'; EPI_INDEX=tranwrd(EPI_INDEX_OLD,'1931-0004','5480-0002'); end;
		else if INITIATOR_BPID_old='1931-0005' then do; BPID_change=1; INITIATOR_BPID='5481-0002'; CONVENER_ID='5481_0001'; EPI_INDEX=tranwrd(EPI_INDEX_OLD,'1931-0005','5481-0002'); end;
		else if INITIATOR_BPID_old='1907-0000' then do; BPID_change=1; INITIATOR_BPID='5746-0002'; CONVENER_ID='5746_0001'; EPI_INDEX=tranwrd(EPI_INDEX_OLD,'1907-0000','5746-0002'); end;
		else if INITIATOR_BPID_old='5105-0148' then do; BPID_change=1; INITIATOR_BPID='5916-0002'; CONVENER_ID='5916_0001'; EPI_INDEX=tranwrd(EPI_INDEX_OLD,'5105-0148','5916-0002'); end;
		else if INITIATOR_BPID_old='5387-0069' then do; BPID_change=1; INITIATOR_BPID='6049-0002'; CONVENER_ID='6049_0001'; EPI_INDEX=tranwrd(EPI_INDEX_OLD,'5387-0069','6049-0002'); end;
		else if INITIATOR_BPID_old='5387-0074' then do; BPID_change=1; INITIATOR_BPID='6050-0002'; CONVENER_ID='6050_0001'; EPI_INDEX=tranwrd(EPI_INDEX_OLD,'5387-0074','6050-0002'); end;
		else if INITIATOR_BPID_old='5387-0079' then do; BPID_change=1; INITIATOR_BPID='6051-0002'; CONVENER_ID='6051_0001'; EPI_INDEX=tranwrd(EPI_INDEX_OLD,'5387-0079','6051-0002'); end;
		else if INITIATOR_BPID_old='5387-0081' then do; BPID_change=1; INITIATOR_BPID='6052-0002'; CONVENER_ID='6052_0001'; EPI_INDEX=tranwrd(EPI_INDEX_OLD,'5387-0081','6052-0002'); end;
		else if INITIATOR_BPID_old='5387-0084' then do; BPID_change=1; INITIATOR_BPID='6053-0002'; CONVENER_ID='6053_0001'; EPI_INDEX=tranwrd(EPI_INDEX_OLD,'5387-0084','6053-0002'); end;
		else if INITIATOR_BPID_old='5424-0002' then do; BPID_change=1; INITIATOR_BPID='6054-0002'; CONVENER_ID='6054_0001'; EPI_INDEX=tranwrd(EPI_INDEX_OLD,'5424-0002','6054-0002'); end;
		else if INITIATOR_BPID_old='5424-0003' then do; BPID_change=1; INITIATOR_BPID='6055-0002'; CONVENER_ID='6055_0001'; EPI_INDEX=tranwrd(EPI_INDEX_OLD,'5424-0003','6055-0002'); end;
		else if INITIATOR_BPID_old='5424-0004' then do; BPID_change=1; INITIATOR_BPID='6056-0002'; CONVENER_ID='6056_0001'; EPI_INDEX=tranwrd(EPI_INDEX_OLD,'5424-0004','6056-0002'); end;
...
%macro out(table);
	%if &table.=TP_Components %then %do;
		proc sql;
			create table out.&table._all as
			select a.*
			from &table. as a
			inner join ref.bpcia_episode_initiator_info as b
			on a.initiator_bpid = b.BPCI_Advanced_ID_number_2
		...
		data out.&table._pmr out.&table._oth out.&table._cc out.&table._1;
			...
			else if initiator_bpid in (&BASELINE_lst.) then output out.&table._cc;
		...
		proc export
			data=out.&table._cc
			outfile="R:\data\HIPAA\BPCIA_BPCI Advanced\08 - Target Price Data\&table._cc.csv"
			dbms=CSV 
			replace;
		run;
		proc export
	...
	proc export
		data=out.&table._all
		outfile="R:\data\HIPAA\BPCIA_BPCI Advanced\08 - Target Price Data\&table._all.csv"
		dbms=CSV 
		replace;
	run;
%mend out;
