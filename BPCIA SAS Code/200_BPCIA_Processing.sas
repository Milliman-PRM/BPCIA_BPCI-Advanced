...
libname out "&dataDir.\07 - Processed Data\";
proc printto log="H:\BPCIA_BPCI Advanced\50 - BPCI Advanced Ongoing Reporting - 2019\Work Papers\SAS\logs\200 - BPCIA Processing_&label._&sysdate..log";
run;
%end;
%else %if &mode.=base %then %do;
libname out "&dataDir.\07 - Processed Data\Baseline Interface Demo";
proc printto log="H:\BPCIA_BPCI Advanced\50 - BPCI Advanced Ongoing Reporting - 2019\Work Papers\SAS\logs\200 - Baseline BPCIA Processing_&label._&sysdate..log";
run;
%end;
%mend modesetup;
